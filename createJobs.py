...
for category in [["2j0t",c2j0t],["2j1t",c2j1t],["3j1t",c3j1t],["3j2t",c3j2t]]:
    for var in [
        ...
        ["ljet_mass","#eta(bjet)","GeV",EquiBinning(50,0,80)],
        ["ljet_dr","#Delta R","",EquiBinning(50,0,7)],
        ["bjet_pt","pT(bjet)","GeV",EquiBinning(50,0,400)],
        ["bjet_eta","#eta(bjet)","",EquiBinning(50,-5,5)],
        ["bjet_mass","#eta(bjet)","GeV",EquiBinning(50,0,80)],
        ["cos_theta_whel_lj","cos#theta_{whel}","",EquiBinning(50,-1,1)],
        ["cos_theta_lj","cos#theta_{lj}","",EquiBinning(50,-1,1)],
        ["top_pt","pT(top)","GeV",EquiBinning(50,0,500)],
        ["top_eta","#eta(top)","",EquiBinning(50,-6,6)],
        ["top_mass","m(top)","GeV",EquiBinning(50,0,800)],
